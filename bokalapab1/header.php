...
<html>
    <head>
       <title>bokala pab Gram Panchayat Welcome you</title>
	...
	<!--[if lte IE 9]><script type="text/javascript" src="engine1/ie.js"></script><![endif]-->
        ...
        <META NAME="Subject" CONTENT="bokala pab Gram Panchayat, himanchal pardesh">
        <META NAME="Description" CONTENT="Welcome to bokala pab gram panchayat. it is a first website of bokala pab gram panchayat. it is made by gram pradhan.  ">
        <META NAME="Keywords" CONTENT="bokala pab Gram Panchayat,bokala pab gram panchayat,bokala pab gram panchayat pontashaib ,bokala pab gram panchayat himanchal predesh ,himanchal predesh gram panchayat, gram panchyat  provide best facility for accomdation">
	 ...
	 <a href="important-information.php">महत्वपूर्ण जानकारी </a>&nbsp;
      ...
      <div id="headerconatiner">
          <div id="headerconatinerleft">
              <h3><a href="index.php">बौकाला पाब ग्राम पंचायत </a> 
<span style="font-size:14px;"><br/> निर्माणवर्ष जनवरी 2016 &nbsp; &nbsp; &nbsp; &nbsp; वर्तमान प्रधान    श्री खेउटा राम शर्मा </span></h3>
            
          </div>
          <div id="headerconatinerright">
              <p> <img src="../social/E-mail-icon.jpg" />&nbsp bokalapab@grampanchayat.org || <a align="right" href="http://www.grampanchayat.org/webmail" target="_blank" >webmail</a></p>
              <p> <img src="../social/phone.png" />&nbsp+91-9805486388</p>
      ...
      <div id="menu"> 
          ...
          <a href="brave-people.php"> <span  id="menutext"> वीर महिला@पुरुष   </span> </a> |
