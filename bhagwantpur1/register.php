    ...
    <?php 
      if (isset($_POST['submit'])) 
      {
         include 'conn.php';
          ...
          $ph_number = mysqli_real_escape_string($con, $_REQUEST['ph_number']);
          $email = mysqli_real_escape_string($con, $_REQUEST['email']);
          $pin_code = mysqli_real_escape_string($con, $_REQUEST['pin_code']);
          $gp_name = mysqli_real_escape_string($con, $_REQUEST['gp_name']);
          $occupation = mysqli_real_escape_string($con, $_REQUEST['occupation']);
          $qualification = mysqli_real_escape_string($con, $_REQUEST['qualification']);
          $stream = mysqli_real_escape_string($con, $_REQUEST['stream']);
