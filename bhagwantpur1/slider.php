...

{
	...
	echo "				<li>
							<div>
								<img data-src='admin/".$row['image']."' height='350px' width='1000px' data-thumb-src='admin/".$row['image']."' title='".$row['alt']."' alt='' data-content-type='image' data-content='' data-interval='-1'/>
