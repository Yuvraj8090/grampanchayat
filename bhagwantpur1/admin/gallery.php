                ...
                if (mysqli_num_rows($result) > 0) 
                    {
                        ...
                        {
                             echo '<tr><td>'.$i.'</td><td><a href="' . $row['gallery'] . '"><img src="' . $row['gallery'] . '"height="150px" width="150px"/></a></td><td>'.$row["alt"].'</td></td><td><a href="photoedit.php?id='.$row["id"].'">edit</a> | <a href="photodelete.php?id='.$row["id"].'">delete</a></td></tr>';
                                  $i++;
                        } 
                    }
                else
