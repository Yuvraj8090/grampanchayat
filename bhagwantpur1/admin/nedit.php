...
<div id="content">
    ...
    <a href="latest_news.php">Go Back</a>
        <?php 
include("conn.php");
mysqli_set_charset( $con, 'utf8');
$id=$_REQUEST['id'];
$sql = "SELECT  id, news FROM latest_news where id='$id' ";
...
<form action="#" method="post"/>
    <input type="text" name="news" value="<?php echo $news; ?>" style="height:50%;"><br/>
     ...
     <button name="submit" style="margin-left:400px;">Submit</button><br/><br/>
       <?php  
        if (isset($_REQUEST['submit'])) 
        {
          ...
          $update = "UPDATE latest_news SET news = '$news' WHERE id = '$id'";
