      ...
      <div class="main">
         <form action="add_news.php">
                ...
                <div class="table">
                      ...
                      $sql="SELECT id, title, news FROM latest_news WHERE ddelete = 0";
                      ...
                      if($rowcount)
                        {
                            ...
                            echo '<tr style="font-weight:bold;font-size:18px;"><td>क्रमांक</td><td>खबरे  </td><td>Operations</td></tr>';
                              ...
                              while($row=mysqli_fetch_assoc($result))                              
                              {
                                  ...
                                  echo '<tr><td>'.$i.'</td><td>'.$row["title"].'</td><td><a href="nedit.php?id='.$row["id"].'">edit</a> | <a href="ndelete.php?id='.$row["id"].'">delete</a></td></tr>';
                                  $i++;
