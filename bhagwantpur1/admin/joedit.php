...
<div id="content">
    ...
    <a href="jobs.php">Go Back</a>
        <?php 
include("conn.php");
mysqli_set_charset( $con, 'utf8');
$id=$_REQUEST['id'];
$sql = "SELECT  id, jobs FROM jobs where id='$id' ";
...
<form action="#" method="post"/>
      <input type="text" name="jobs" value="<?php echo $jobs; ?>" style="height:50%;"><br/>
     <button name="submit" style="margin-left:400px;">Submit</button><br/><br/>
       <?php  
        if (isset($_REQUEST['submit'])) 
        {
          ...
          $jobs = mysqli_real_escape_string($con, $_POST['jobs']);
          
          $update = "UPDATE jobs SET jobs = '$jobs' WHERE id = '$id'";
