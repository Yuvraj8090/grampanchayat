       ...
       <div class="form">
            <form action="#" method="post">
                <fieldset style="font-size:16px;">
                    <legend style="margin-left:10px;width:230px;font-size:30px;">सरकारी नौकरियों   </legend>
                   ...
                   <textarea rows="10" name="jobs"></textarea>
			...
			<?php 
				...
				{	
					...
					$jobs = mysqli_real_escape_string($con, $_REQUEST['jobs']);
					
					
					$insert = "INSERT INTO jobs (title, jobs) VALUES ('$title', '$jobs')";
