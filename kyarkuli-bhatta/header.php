...
<html>
    <head>
       <title>kyarkuli bhatta Gram Panchayat Welcome you</title>
	...
	<?php include '../headerlink.php';  ?>
      ...
      <div id="headerconatiner">
          <div id="headerconatinerleft">
              <h3><a href="index.php">क्यारकुली भट्टा ग्राम पंचायत</a> 
<span style="font-size:14px;"><br/> निर्माणवर्ष 20 मई २०१७  &nbsp; &nbsp; &nbsp; &nbsp; वर्तमान निशा</span></h3>
            
          </div>
          <div id="headerconatinerright">kyarkulibhatta@grampanchayat.org || <a align="right" href="http://www.grampanchayat.org/webmail" target="_blank" >webmail</a></p>
              <p> <img src="../social/phone.png" />&nbsp+91-8475906985</p>
