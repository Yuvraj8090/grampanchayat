...
<div class="container">
    ...
    <br><br>
    <form action="{{ url('/jan-partinidhi/update/'.$data->id) }}" method="POST">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <select class="form-control" name="position">
                ...
                <option value="{{ $po->name }}" @if($data->position == $po->name) selected @endif > {{ $po->name }}</option>
                @endforeach
                @endif
            </select>
        ...
        <div class="form-group">
            ...
            <input type="number" name="phone" class="form-control" id="exampleInputPassword1" value="{{ $data->phone }}" placeholder="Phone No.">
            @if ($errors->has('phone'))
            <span class="help-block">
        ...
        <div class="form-group">
            ...
            <input type="text" name="block" class="form-control" id="exampleInputPassword1" value="{{ $data->block }}" placeholder="Phone No.">
            @if ($errors->has('block'))
            <span class="help-block">
