            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="card shadow-sm h-100">
                        <div class="card-header bg-primary text-white">Pradhan & Hero Section</div>
                        <div class="card-body">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Pradhan Contact</label>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Welcome Text (About)</label>
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-6">
                                    ...
                                    <input type="number" name="total_population" class="form-control" value="{{ $details->total_population }}">
                                </div>
                                <div class="col-6">
                                    <label class="form-label">Literacy Rate (%)</label>
                                    <input type="text" name="literacy_rate" class="form-control" value="{{ $details->literacy_rate }}">
                                </div>
                                <div class="col-6">
                                    <label class="form-label">Male Population</label>
                                    <input type="number" name="male_population" class="form-control" value="{{ $details->male_population }}">
                                </div>
                                <div class="col-6">
                                    <label class="form-label">Female Population</label>
                                    <input type="number" name="female_population" class="form-control" value="{{ $details->female_population }}">
                                </div>
                                <div class="col-6">
                                    <label class="form-label">Total Families</label>
                                    <input type="number" name="total_families" class="form-control" value="{{ $details->total_families }}">
                                </div>
                                <div class="col-6">
                                    <label class="form-label">SC/ST Population</label>
                                    <input type="number" name="sc_st_population" class="form-control" value="{{ $details->sc_st_population }}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="card shadow-sm">
                        <div class="card-header bg-dark text-white">Contact & Media</div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label">Official Email</label>
                                    <input type="email" name="contact_email" class="form-control" value="{{ $details->contact_email }}">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="video_url" class="form-control" value="{{ $details->video_url }}" placeholder="https://www.youtube.com/embed/...">
                                </div>
                            </div>
                        </div>
                    </div>
