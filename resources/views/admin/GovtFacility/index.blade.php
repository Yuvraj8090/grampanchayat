...
<div class="table-responsive">
    ...
    <div style="padding-left:50px;" >
        ...
        <a class="btn bt-md btn-primary" href="{{ route('govtfacility.create') }}">Add </a>
        <br><br>
    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-info btn-sm" href="{{ route('govtfacility.edit',$d->id) }}">Edit</a>
                    <a class="btn btn-danger btn-sm" onClick="return confirm('Are you sure ?')" href="{{ url('govtfacility/delete/'.$d->id) }}">Delete</a>
                </td>
