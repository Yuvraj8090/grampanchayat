<x-app-layout title="Edit Business">
    <div class="container-fluid py-4">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card shadow-sm">
                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 text-primary"><i class="fas fa-edit me-2"></i> Edit Business: {{ $business->title }}</h5>
                        <a href="{{ route('admin.panchayats.businesses.index', $panchayat->id) }}" class="btn btn-sm btn-outline-secondary">Back</a>
                    </div>
                    <div class="card-body p-4">
                        <form action="{{ route('admin.panchayats.businesses.update', [$panchayat->id, $business->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" name="title" class="form-control" value="{{ $business->title }}" required>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="description" class="form-control" rows="5">{{ $business->description }}</textarea>
                                </div>

                                <div class="col-12 text-end mt-4">
                                    <button type="submit" class="btn btn-primary px-4">
                                        <i class="fas fa-sync me-1"></i> Update Business
                                    </button>
                                </div>
                            </div>
                        </form>
