...
<div style="margin:10px 50px;">
    <div  class="card">
          ...
          <div class="card-body">
                ...
                <input type="textbox" class="form-control" name="link_title"  value="{{ $add->link_title ?? request()->link_title ?? '' }}"  />
                ...
                <input type="url" class="form-control" name="link"  value="{{ $add->link ?? request()->link ?? '' }}"  />
                 @if ($errors->has('link'))
                    <span class="help-block">
