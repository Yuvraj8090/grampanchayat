...
<header class="brand-header">
    <div class="container">
        <div class="row align-items-center" style="background: url('https://grampanchayat.org/images/back.jpg') no-repeat center center; 
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('public.tourist_places.show') ? 'active' : '' }}"
                        href="{{ route('public.tourist_places.show', $panchayat->id) }}">
                        मुख्य स्थल
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('public.contact.*') ? 'active' : '' }}" href="#">
                        संपर्क करें
                    </a>
                </li>
