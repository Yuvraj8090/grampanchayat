    ...
    <div class="sidebar-dark border-end" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush my-3">
            ...
            <a href="#" class="list-group-item list-group-item-action px-4 py-2">
                <i class="fa-solid fa-file-contract me-3"></i> प्रमाण पत्र
            </a>

            <a href="#" class="list-group-item list-group-item-action px-4 py-2">
                <i class="fa-solid fa-bullhorn me-3"></i> शिकायतें
            </a>
        </div>
    </div>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle d-flex align-items-center" href="#"
                                ...
                                @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                    <img class="rounded-circle me-2 border object-fit-cover" width="35"
