...
<a href="{{route('user-work.index')}}" class="btn btn-primary btn-xs"><i class="fa fa-arrow-left fa-fw"></i> Go Back</a>
    <br/><br/>
    <div class="container">
    {!! Form::open(['method'=>'POST', 'action'=>'UserWork@store', 'files'=>true]) !!}

        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
            <label>कार्य का नाम:</label>
            <input type="text" name="name" class="form-control" value="{{ old('name') }}" required="required" placeholder="कार्य का नाम">
            @if ($errors->has('name'))
        ...
        <div class="form-group{{ $errors->has('y_name') ? ' has-error' : '' }}">
            ...
            <input type="text" name="y_name" class="form-control" value="{{ old('y_name') }}" required="required" placeholder="योजना का नाम">
        ...
        <div class="form-group{{ $errors->has('year') ? ' has-error' : '' }}">
            <label>वर्ष:</label>
            <input type="text" name="year" class="form-control" value="{{ old('year') }}" required="required" placeholder="वर्ष">
            @if ($errors->has('year'))
                <span class="help-block">
        ...
        <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
            <label>राशि:</label>
            <input type="text" name="price" class="form-control" value="{{ old('price') }}" required="required" placeholder="राशि">
            @if ($errors->has('price'))
                <span class="help-block">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group{{ $errors->has('oldimage') ? ' has-error' : '' }}">
                    ...
                    <input type="file" name="oldimage" required="required">
            ...
            <div class="col-md-6">
                <div class="form-group{{ $errors->has('newimage') ? ' has-error' : '' }}">
                    <label>नए फोटो:</label>
                    <input type="file" name="newimage" required="required">
