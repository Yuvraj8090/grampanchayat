...
<a href="{{route('user-p-message.index')}}" class="btn btn-primary btn-xs"><i class="fa fa-arrow-left fa-fw"></i> Go Back</a>
    <br/><br/>
    <div class="container">
    {!! Form::model($msg, ['method'=>'PATCH', 'action'=>['UserPmsg@update', $msg->id], 'files'=>true]) !!}

        <div class="form-group{{ $errors->has('msg') ? ' has-error' : '' }}">
            <label>Message</label>
            <input type="text" name="msg" value="{{$msg->msg}}" class="form-control te" style="min-height:400px;">
            @if ($errors->has('msg'))
        ...
        <div class="form-group">
            <img src="/images/{{$msg->image}}" class="img-responsive" style="width:200px;height:200px;">
        </div>
