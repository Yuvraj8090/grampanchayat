...
@section('content')
    ...
    <a class="btn btn-primary btn-xs band" href="{{route('user-introduction.create')}}">
            ...
            <tbody>
                @foreach($intro as $intros)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('user-introduction.edit', $intros->id) }}" class="btn btn-success btn-xs">
