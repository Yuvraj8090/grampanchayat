...
<a href="{{route('user-facts.index')}}" class="btn btn-primary btn-xs"><i class="fa fa-arrow-left fa-fw"></i> Go Back</a>
    <br/><br/>
    <div class="container">
    {!! Form::open(['method'=>'POST', 'action'=>'UserFact@store']) !!}

        <div class="form-group{{ $errors->has('facts') ? ' has-error' : '' }}">
            <label>मुख्य तथ्य</label>
            <input type="text" name="facts" class="form-control" placeholder="मुख्य तथ्य" required="required">
            @if ($errors->has('facts'))
        ...
        <div class="form-group{{ $errors->has('number') ? ' has-error' : '' }}">
            <label>संख्या</label>
            <input type="text" name="number" class="form-control" placeholder="संख्या" required="required">
