...
@section('content')
    ...
    <a href="{{route('user-business-intro.create')}}" class="btn btn-primary btn-xs band">
            ...
            <tbody>
                @foreach($add as $address)
                    <tr>
                        ...
                        <td>
                            <a href="{{route('user-business-intro.edit', $address->id)}}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i> Edit</a>
                        </td>
                    </tr>
                @endforeach
