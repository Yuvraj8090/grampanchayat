...
<html>
    <head>
       <title>Jeevangarh Gram Panchayat Welcome you</title>
	...
	<!--[if lte IE 9]><script type="text/javascript" src="engine1/ie.js"></script><![endif]-->
        ...
        <META NAME="Subject" CONTENT="Jeevangarh Gram Panchayat, Uttarakhand">
        <META NAME="Description" CONTENT="Welcome to Jeevangarh gram panchayat. it is a first website of Jeevangarh gram panchayat. it is made by gram pradhan.  ">
        <META NAME="Keywords" CONTENT="Jeevangarh Gram Panchayat,Jeevangarh gram panchayat,Jeevangarh gram panchayat dehradun ,Jeevangarh gram panchayat vikasnagar ,uttarakhand gram panchayat,gram panchyat  provide best facility for accomdation">
...
<script type='text/javascript'>
  ...
  <div id="headerconatiner">
          <div id="headerconatinerleft">
              <h3><a href="index.php">जीवनगढ़ ग्राम पंचायत</a> 
<span style="font-size:14px;"><br/> निर्माणवर्ष जनवरी २०१५ &nbsp; &nbsp; &nbsp; &nbsp; वर्तमान प्रधान  पंकज कुमार सोनू  </span></h3>
            
          </div>
          <div id="headerconatinerright">
<p> <img src="../social/E-mail-icon.jpg" />&nbsp Jeevangarh@grampanchayat.org || <a align="right" href="http://www.grampanchayat.org/webmail" target="_blank" >webmail</a></p>
              <p> <img src="social/phone.png" />&nbsp+91-9412348777 , +91-9557050777</p>
