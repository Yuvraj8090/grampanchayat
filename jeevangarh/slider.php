<link rel="stylesheet" href="engine1/style.css">
	...
	<div class='csslider1 autoplay '>
		...
		<ul>
			<div>
				<img src="data1/images/untitled1.jpg" style="width: 100%;">
			</div>
			<li class='num0 img'>
				<img src='data1/images/untitled1.jpg' alt='Untitled-1' title='Untitled-1' />
			</li>
		...
		<div class='cs_description'>
			<label class='num0'>
				<span class="cs_title"><span class="cs_wrapper">Untitled-1</span></span>
		...
		<div class='cs_bullets'>
			<label class='num0' for='cs_slide1_0'>
				...
				<span class='cs_thumb'><img src='data1/tooltips/untitled1.jpg' alt='Untitled-1' title='Untitled-1' /></span>
			</label>
		</div>
