        ...
        <div class="main">       
            ...
            <form action="#" method="post" enctype="multipart/form-data">
                <fieldset style="font-size:16px;">
                    <legend style="margin-left:10px;width:160px;font-size:30px;">मुख्य स्थल</legend>
...
if (isset($_POST['submit'])) 
{
    ...
    $insert = "INSERT INTO places (name, about, image, ddelete) VALUES ('$name', '$about', '$image', '0')";
