...
while($row = mysqli_fetch_assoc($result)) 
{
     echo ' <span class="control-label col-lg-4" style="font-size:20px;">पुराणी फोटो:</span><img src="' . $row['oldphotos'] . '" alt="no image" height="150px" width="150px"/><br/><br/>';
     echo ' <span class="control-label col-lg-4" style="font-size:20px;">नए फोटो:</span><img src="' . $row['newphotos'] . '" alt="no image" height="150px" width="150px"/>';
  } 
}
?><br/><br/>
