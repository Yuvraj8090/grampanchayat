       ...
       <div class="form">
            <form action="#" method="post">
                <fieldset style="font-size:16px;">
                    <legend style="margin-left:10px;width:230px;font-size:30px;">Running योजनाए  </legend>
                   ...
                   <textarea rows="10" name="programme"></textarea>
			...
			<?php 
				...
				{	
					...
					$programme = mysqli_real_escape_string($con, $_REQUEST['programme']);
					
					
					$insert = "INSERT INTO running_programme (title, programme) VALUES ('$title', '$programme')";
