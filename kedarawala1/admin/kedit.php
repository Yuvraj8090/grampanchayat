...
$id=$_REQUEST['id'];
$sql = "SELECT  id, facts, numbers FROM key_facts WHERE id='$id' ";
     ...
     <input type="submit" name="submit" style="margin-left:400px;" value="Submit" /><br/><br/>
       <?php  
        if (isset($_REQUEST['submit'])) 
        {
          ...
          $facts = mysqli_real_escape_string($con, $_POST['facts']);
		  $number = mysqli_real_escape_string($con, $_POST['number']);
		  
          
          $update = "UPDATE key_facts SET facts = '$facts', numbers = '$number' WHERE id = '$id'";
