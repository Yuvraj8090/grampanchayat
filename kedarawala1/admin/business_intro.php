...
<div id="content">
    <div class="inner" style="min-height: 700px;padding-top:10px;">
        <div class="main">
            <form action="add_business_intro.php">
                      ...
                      if($rowcount)
                        {
                            ...
                            echo '<tr style="font-weight:bold;font-size:18px;"><td>परिचय </td><td>Operations</td></tr>';
                              ...
                              while($row=mysqli_fetch_assoc($result))                              
                              {
                                  ...
                                  echo '<tr><td>'.$row["intro"].'</td><td><a href="biedit.php?id='.$row["id"].'">edit</a></td></tr>'.'<style>button{display:none;}</style>';
