		...
		<?php 
			...
			if (mysqli_num_rows($result) > 0) 
			{
				while($row = mysqli_fetch_assoc($result)) 
				{
					...
					{
						echo '<tr><td style="padding-left:10px;padding-top:20px;">पुराणी फोटो:</td><td><img src="admin/' . $row['oldphotos'] . '"height="150px" width="150px" style="margin-left:20px;margin-top:20px;"/></td></tr>';
   					echo '<tr><td style="padding-left:10px;padding-top:20px;">नए फोटो:</td><td><img src="admin/' . $row['newphotos'] . '"height="150px" width="150px" style="margin-left:20px;"/></td></tr>';
					}
					else
					{
