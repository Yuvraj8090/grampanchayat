...
<div class="body">
	<div class="left_box">
		<br/>
		<div class="heading">केदारावाला ग्राम पंचायत</div>
		<div class="table">
			<?php 
                include 'conn.php' ;
		...
		<br/><br/>
		<div class="heading">केदारावाला ग्राम पंचायत मे पहुचने के साधन</div>
		<div class="table">
		...
		<br/><br/>
		<div class="heading">केदारावाला ग्राम पंचायत से जनपद स्तर के मुख्य विभाग और उनकी दुरी</div>
		<div class="table">
			<?php 
                include 'conn.php' ;
                mysqli_set_charset( $con, 'utf8');
