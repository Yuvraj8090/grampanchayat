	...
	<table width="100%" class="show_table">
		...
		<?php 
			...
			if (mysqli_num_rows($result) > 0) 
			{
				while($row = mysqli_fetch_assoc($result)) 
				{
  				   echo '<tr><td style="padding-left:10px;padding-top:20px;">फोटो:</td><td><img src="admin/' . $row['janphoto'] . '"height="150px" width="150px" style="margin-left:20px;margin-top:20px;"/></td></tr>';
     			} 
			}
		?>
		<tr>
