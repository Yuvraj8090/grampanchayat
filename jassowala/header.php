...
<html>
    <head>
       <title>Jassowala Farm Gram Panchayat Welcome you</title>
	...
	<!--[if lte IE 9]><script type="text/javascript" src="engine1/ie.js"></script><![endif]-->
        ...
        <META NAME="Subject" CONTENT="jassowala Gram Panchayat, Uttarakhand">
        <META NAME="Description" CONTENT="Welcome to jassowala gram panchayat. it is a first website of jassowala gram panchayat. it is made by gram pradhan.  ">
        <META NAME="Keywords" CONTENT="jassowala Gram Panchayat,jassowala gram panchayat,jassowala gram panchayat dehradun ,jassowala gram panchayat vikasnagar ,uttarakhand gram panchayat,gram panchyat  provide best facility for accomdation">
	 ...
	 <a href="important-information.php">महत्वपूर्ण जानकारी </a>&nbsp;
      ...
      <div id="headerconatiner">
          <div id="headerconatinerleft">
              <h3><a href="index.php"></a>जस्सोवाला  ग्राम पंचायत
<span style="font-size:14px;"><br/> निर्माणवर्ष जनवरी २०१५ &nbsp; &nbsp; &nbsp; &nbsp; वर्तमान प्रधान    श्री प्रदीप कुमार  </span></h3>
            
          </div>
          <div id="headerconatinerright">
              <p> <img src="../social/E-mail-icon.jpg" />&nbsp jassowala@grampanchayat.org || <a align="right" href="http://www.grampanchayat.org/webmail" target="_blank" >webmail</a></p>
              <p> <img src="../social/phone.png" />&nbsp+91-</p>
