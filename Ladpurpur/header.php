...
<html>
    <head>
       <title>Ladpur Gram Panchayat Welcome you</title>
	...
	<?php include '../headerlink.php';  ?>
      ...
      <div id="headerconatiner">
          <div id="headerconatinerleft">
              <h3><a href="index.php">लाडपुर ग्राम पंचायत</a> 
<span style="font-size:14px;"><br/> निर्माणवर्ष 20 मई २०१७  &nbsp; &nbsp; &nbsp; &nbsp; वर्तमान घनश्याम पाल   </span></h3>
            
          </div>
          <div id="headerconatinerright">
              <p> <img src="../social/E-mail-icon.jpg" />&nbsp ladpur@grampanchayat.org || <a align="right" href="http://www.grampanchayat.org/webmail" target="_blank" >webmail</a></p>
              <p> <img src="../social/phone.png" />&nbsp+91-9412975220</p>
