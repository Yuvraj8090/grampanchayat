...
<head>
	...
	<title>Nevi Garam Panchayat</title>
		...
		<div class="inner_box">
			<div class="header">
				...
				<div class="middle_header">
					<div class="head">नेवी ग्राम पंचायत
					<?php 
					include 'conn.php';
					mysqli_set_charset( $con, 'utf8');
					$fetch = "SELECT jname FROM janparthinidhi WHERE position = 'प्रधान'";
					$query = mysqli_query($con, $fetch);
					$result = mysqli_fetch_assoc($query);
					?>
						<span style="font-size:16px;"><br/> निर्माणवर्ष 20 मई २०१७ <br/> वर्तमान: <?php echo $result['jname'];?></span>
					</div>
					<div class="clear"></div>
				</div>
