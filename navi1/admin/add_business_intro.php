        ...
        <div class="main">       
            ...
            <form action="#" method="post">
                <fieldset style="font-size:16px;">
                    <legend style="margin-left:10px;width:160px;font-size:30px;">परिचय</legend>
                    <textarea rows="10" name="intro"></textarea><br/>
...
if (isset($_POST['submit'])) 
{
    ...
    $insert = "INSERT INTO business_intro (intro) VALUES ('$intro')";
