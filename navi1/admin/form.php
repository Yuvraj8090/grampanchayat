        ...
        <div class="main">       
            ...
            <form action="#" method="post" enctype="multipart/form-data">
                <fieldset style="font-size:16px;">
                    ...
                    <span class="control-label col-lg-4" style="font-size:20px;">वर्ष:</span> <input type="date" name="year" class="form-control" style="width:60%;" placeholder="dd-mm-yyyy" required=""> <br/><br/>
...
if (isset($_POST['submit'])) 
{
    ...
    $progress_status = mysqli_real_escape_string($con, $_POST['progress_status']);
     ...
     $insert = "INSERT INTO development_works (dworkname, about_work, plan_name, year, price, progress_status, oldphotos, newphotos) VALUES ('$dworkname', '$about_work', '$plan_name', '$year', '$price', '$progress_status', '$oldphotos', '$newphotos')";
