...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'aquamag' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'aquamag' ),
		'repeat-y'  => __( 'Repeat Vertically', 'aquamag' ),
		'repeat'    => __( 'Repeat All', 'aquamag' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'aquamag' ),
		'top center'    => __( 'Top Center', 'aquamag' ),
		'top right'     => __( 'Top Right', 'aquamag' ),
		'center left'   => __( 'Middle Left', 'aquamag' ),
		'center center' => __( 'Middle Center', 'aquamag' ),
		'center right'  => __( 'Middle Right', 'aquamag' ),
		'bottom left'   => __( 'Bottom Left', 'aquamag' ),
		'bottom center' => __( 'Bottom Center', 'aquamag' ),
		'bottom right'  => __( 'Bottom Right', 'aquamag')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'aquamag' ),
		'fixed'  => __( 'Fixed in Place', 'aquamag')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'aquamag' ),
		'italic'      => __( 'Italic', 'aquamag' ),
		'bold'        => __( 'Bold', 'aquamag' ),
		'bold italic' => __( 'Bold Italic', 'aquamag' )
		);
