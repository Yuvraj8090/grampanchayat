 ...
 * @since      1.0.0
 */
class AquaMag_Ads_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-aquamag-ad ad-widget',
			'description' => __( 'Easily to display any type of ad.', 'aquamag' )
		);

		// Create the widget.
		$this->WP_Widget(
			'aquamag-ads',                            // $this->id_base
			__( '&raquo; Advertisement', 'aquamag' ), // $this->name
