		...
		<?php if ( have_posts() ) : ?>
			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> <?php hybrid_attr( 'post' ); ?>>
					...
					<?php
						// Check if the required plugin active.
					...
					?>
						...
						<div class="entry-content" <?php hybrid_attr( 'entry-content' ); ?>>
							...
							<?php $args = apply_filters( 'truenews_team_query', array( 'post_type' => 'member', 'posts_per_page' => -1 ) ); ?>
					...
					<?php else : ?>
						...
						<div class="entry-content">
							<p><?php printf( __( 'Please install %1$sTheme Junkie Team Content%2$s plugin to use this page template.', 'truenews' ), '<a href="http://wordpress.org/plugins/theme-junkie-team-content/" target="_blank">', '</a>' ); ?></p>
						</div><!-- .entry-content -->
