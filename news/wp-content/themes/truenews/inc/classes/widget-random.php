 ...
 * @since      1.0.0
 */
class TrueNews_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-truenews-random posts-thumbnail-widget',
			'description' => __( 'Display random posts with thumbnails.', 'truenews' )
		);

		// Create the widget.
		$this->WP_Widget(
			'truenews-random',                                   // $this->id_base
			__( '&raquo; Random Posts Thumbnails', 'truenews' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Random Posts', 'truenews' ),
			'limit'     => 5,
			'show_date' => false
		);
