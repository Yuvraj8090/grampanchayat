 ...
 * @since      1.0.0
 */
class TrueNews_Ads_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-truenews-ad ad-widget',
			'description' => __( 'Easily to display any type of ad.', 'truenews' )
		);

		// Create the widget.
		$this->WP_Widget(
			'truenews-ads',                            // $this->id_base
			__( '&raquo; Advertisement', 'truenews' ), // $this->name
