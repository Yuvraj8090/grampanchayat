 ...
 * @since      1.0.0
 */
class TrueNews_Video_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-truenews-video video-widget',
			'description' => __( 'Easily to display any type of video.', 'truenews' )
		);

		// Create the widget.
		$this->WP_Widget(
			'truenews-video',                  // $this->id_base
			__( '&raquo; Video', 'truenews' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'      => esc_html__( 'Video', 'truenews' ),
			'video_url'  => '',
			'video_code' => ''
		);
