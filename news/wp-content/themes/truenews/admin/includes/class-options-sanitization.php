...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'truenews' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'truenews' ),
		'repeat-y'  => __( 'Repeat Vertically', 'truenews' ),
		'repeat'    => __( 'Repeat All', 'truenews' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'truenews' ),
		'top center'    => __( 'Top Center', 'truenews' ),
		'top right'     => __( 'Top Right', 'truenews' ),
		'center left'   => __( 'Middle Left', 'truenews' ),
		'center center' => __( 'Middle Center', 'truenews' ),
		'center right'  => __( 'Middle Right', 'truenews' ),
		'bottom left'   => __( 'Bottom Left', 'truenews' ),
		'bottom center' => __( 'Bottom Center', 'truenews' ),
		'bottom right'  => __( 'Bottom Right', 'truenews')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'truenews' ),
		'fixed'  => __( 'Fixed in Place', 'truenews')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'truenews' ),
		'italic'      => __( 'Italic', 'truenews' ),
		'bold'        => __( 'Bold', 'truenews' ),
		'bold italic' => __( 'Bold Italic', 'truenews' )
		);
